# Generated by Powerlevel10k configuration wizard on 2026-02-22 at 23:37 PST.
...
() {
  ...
  # Colon separator before directory, in white, then switch to blue for the path
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=76
